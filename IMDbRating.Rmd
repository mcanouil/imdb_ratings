...
cat("\n# {.tabset .tabset-fade .tabset-pills}\n")
for (iyear in sort(as.character(unique(ratings[["YearRated"]])))) {
  cat("\n##", iyear, "{-}\n")
  ggarrange(
    ggarrange(
      p_movies_theatres[[iyear]],
    ...
    ggarrange(
      ...
      p_genres_distribution[[iyear]] + 
        guides(fill = guide_legend(
          ncol = 1, 
          keyheight = unit(params$ggFontSize*2/3, "pt"),
          keywidth = unit(params$ggFontSize, "pt")
        )), 
      p_ratings_runtime[[iyear]] + 
        guides(fill = guide_legend(
          ncol = 1, 
          keyheight = unit(params$ggFontSize*1.2, "pt"),
          keywidth = unit(params$ggFontSize*1.2, "pt")
        )), 
      ncol = 3,
      align = "v",
