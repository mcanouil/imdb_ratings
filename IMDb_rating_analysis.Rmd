...
if (file.exists("./data/ratings_ms.csv")) {
  source("./data/add_metascore.R")
  ...
  ratings <- readr::read_csv(
    ...
    dplyr::filter(YearRated>=!!min(source("./data/movies_theatres.R")$value[["Year"]]))
}
```
...
data_ratings <- dplyr::full_join(
  x = ratings %>% 
    ...
    dplyr::mutate(
      Who = c("Your" = "Me", "IMDb" = "IMDb Users", "Metascore" = "Metascore")[gsub(" Rating", "", Who)],
